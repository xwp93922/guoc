        ...
        <div class="subPage-wrap">
            <div class="con_1200 clearfix">
                ...
                <div class="content-box">
					...
					<?php if(!empty($joinStyles)){?>
                    <ul class="article-content clearfix">
                    <?php foreach ($joinStyles as $style){?>
                        <li class="good-team"  onclick="window.location.href='<?= Url::toRoute(['site/style-detail','sname'=>$_SESSION['serial_id'],'id'=>$style['id']]) ?>'">
                            <dl>
                                <dt class="img-case32"><img src="<?= SiteHelper::getImgSrc($style['image_main'])?>"></dt>
                                <dd class="Item-describe"><?= $style['name'] ?></dd>
                            </dl>
                        </li>
					<?php }?>
                    </ul>
