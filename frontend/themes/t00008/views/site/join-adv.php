            ...
            <div class="con_1200 clearfix">
                <div class="aside-box">
                    <div class="aside-block">
                        <p class="title-df">加盟优势<img src="<?= $bundle->baseUrl ?>/img/ico_square_white.png"></p>
                        <ul class="list-df">
                           <li class="li-df"><a href="<?= Url::toRoute(['site/policy','sname'=>$_SESSION['serial_id']]) ?>" class="row-item ">加盟代理政策<i class="case-df"><img src="<?= $bundle->baseUrl ?>/img/ico_white_right.png"></i></a></li>
                            ...
                            <li class="li-df"><a href="<?= Url::toRoute(['site/adv','sname'=>$_SESSION['serial_id']]) ?>"class="row-item choice-on ">加盟优势<i class="case-df"><img src="<?= $bundle->baseUrl ?>/img/ico_white_right.png"></i></a></li>
               ...
               <div class="content-box">
                    <p class="article-title clearfix"><em class=" line-df"></em><span>加盟优势</span><i class="float-rt title-position">您的位置:首页>>加盟政策>>加盟优势</i></p>
