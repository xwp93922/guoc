...
/**
 * This is the model class for table "cms_product_category".
 *
 * @property integer $id
 ...
 */
class CmsProductCategory extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['lang_id', 'site_id', 'name', 'description'], 'required'],
            [['lang_id', 'site_id', 'parent_id', 'sort_val', 'status', 'created_at', 'updated_at'], 'integer'],
            [['name', 'description', 'image_main', 'image_node'], 'string', 'max' => 255],
    ...
    public function uploadImageMain($site_id,$dirName='product/images')
    {
    ...
    public function uploadImageNode($site_id,$dirName='product/images')
    {
