...
class CmsArticle extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['lang_id', 'category_id', 'name', 'summary', 'content'], 'required'],
            [['lang_id', 'site_id', 'category_id', 'status', 'sort_val', 'created_at', 'updated_at', 'view_count', 'recommend'], 'integer'],
            [['content'], 'string'],
            [['name', 'summary', 'meta_keywords', 'meta_description', 'image_main', 'image_node'], 'string', 'max' => 255],
            [['sort_val'], 'default', 'value'=>10],
            [['view_count', 'recommend'], 'default', 'value'=>0],
    ...
    public function uploadImageMain($site_id,$dirName='article/images')
    {
    ...
    public function uploadImageNode($site_id,$dirName='article/images')
    {
