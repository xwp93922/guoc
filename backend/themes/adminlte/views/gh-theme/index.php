...
$this->title = Yii::t('app', 'Theme management');
?>
    ...
    <div class="col-md-12">
    	<div class="box box-success">
                <div class="box-header with-border">
                  <h3 class="box-title"><?php echo Yii::t('app', 'Theme management');?></h3>
                </div>
                <div class="box-body ">
                	<p>
                            ...
                            [
                                ...
                                'buttons'=>[
                                    'user-update' => function ($url, $model, $key) {
                                      return Html::button(Yii::t('yii', 'Update'), ['class'=>'btn btn-success','onclick'=>'window.location.href="'.Url::toRoute(['gh-theme/update','id'=>$model->id]).'";']);
                                    },
                                    'user-delete' => function ($url, $model, $key) {
                                       /*  if ($model->necessary == 1)
                                            return ''; */
                                        return Html::button(Yii::t('yii', 'Delete'), ['class'=>'btn btn-danger','onclick'=>'if (confirm("'.Yii::t('yii', 'Are you sure you want to delete this item?').'")){window.location.href="'.Url::toRoute(['gh-theme/delete','id'=>$model->id]).'";}']);
                                    },
                                ]
                            ],
                        ],
