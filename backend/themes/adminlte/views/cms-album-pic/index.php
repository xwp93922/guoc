    ...
    <div class="col-md-12">
    	<div class="box box-success">
                <div class="box-header with-border">
                  <h3 class="box-title"><?php echo Yii::t('app', 'Cms Album').'：'.$album->name.'('.$album->count_pic.')';?></h3>
                </div>
                <div class="box-body ">
                	<div class="album-pic-list">
                      <ul id="images" class="pull-left">
                      	<?php foreach ($album_pics as $p) {?>
                		<li class="album-pic pull-left pointer">
                			<img src="<?php echo \Yii::getAlias('@web').$p->url?>" />
                			<div class="name">
                    			<?php echo $p->name?>
                    		</div>
                			<div class="delete" rel="<?php echo $p->id;?>"><i class="fa fa-times"></i></div>
                    		<div class="showbig" rel="<?php echo \Yii::getAlias('@web').$p->url;?>"><i class="fa fa-search-plus"></i></div>
...
<div class="page-data hide">
	<span id="delete-pic-url"><?php echo Url::to(['cms-album-pic/delete'],true);?></span>
</div>
